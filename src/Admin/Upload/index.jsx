      ...
      await uploadBytes(imageRef, e.target.files[0])
        .then((snapshot) => {
          getDownloadURL(snapshot.ref).then((url) => {
            setSiteInformation((prev) => ({ ...prev, image: url }));
        ...
        <div className="w-4/5 mx-auto md:px-2 md:mx-4 my-1 py-1 flex flex-col items-center ">
          ...
          <div className="w-full mx-auto my-1 py-1 flex flex-col   ">
            ...
            <textarea
              ...
              draggable={false}
              onChange={(e) => {
                setSiteInformation((prev) => ({ ...prev, name: e.target.value }));
              }}
          ...
          <div className="w-full mx-auto my-1 py-1 flex flex-col">
            ...
            <div className=" py-1 flex flex-row  items-center ">
              <Select
                ...
                required
                onChange={(e) =>
                  setSiteInformation((prev) => ({ ...prev, category: e.value }))
                }
              />
            </div>
          </div>
          {/* <div className="w-full mx-auto my-3  flex flex-col">
            ...
            <div className="w-auto mx-auto md:mx-4 my-3  flex flex-col">
              <div className="w-full h-auto flex flex-col">
                <div>
                  {siteInformation &&
                    siteInformation.features.map((features, i) => (
          ...
          <div className="w-full mx-auto my-1 py-1 flex flex-col">
            ...
            <div className=" py-1 flex flex-row  items-center ">
              <Select
                ...
                required
                onChange={(e) =>
                  setSiteInformation((prev) => ({ ...prev, PayOnDelivery: e.value }))
                }
              />
            </div>
          </div>
