...
const CheckoutDetails = ({ CheckOutData, TotalPrice }) => {
  ...
  const addToOrder = async (paymentMedium) => {
    try {
          ...
          <div className="mx-3  w-full    h-auto  ">
            ...
            <p className="text-sm p-1 text-black font-roboto  flex flex-col ">
              ...
              <textarea
                ...
                onChange={(e) =>
                  setUserInfo((prev) => ({ ...prev, whatsappNumber: e.target.value }))
                }
            ...
            <p className="text-sm p-1 text-black font-roboto  flex flex-col ">
              ...
              <textarea
                ...
                placeholder={""}
                onChange={(e) =>
                  setUserInfo((prev) => ({ ...prev, alternativePhone: e.target.value }))
                }
                className="  my-auto w-52 h-8 p-1  text-sm text-slate-800 font-normal focus:outline-none  resize-none no-scrollbar border-2 border-gray-300 rounded-md"
              ></textarea>
            </p>
            <p className="text-lg  p-1 text-black font-roboto font-bold flex flex-col">
              ...
              <textarea
                ...
                placeholder={"address... "}
                onChange={(e) =>
                  setUserInfo((prev) => ({ ...prev, deliveryAddress: e.target.value }))
                }
